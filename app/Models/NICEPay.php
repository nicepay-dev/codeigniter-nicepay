...
class NICEPay
{
    ...
    function __construct(NICEPayBuilder $builder)
    {
        ...
        $this->isCloudServer = $builder->isCloudServer();
    }
    ...
    public function getNicepayBaseUrl()
    {
        if ($this->isProduction) {
            ...
            return NicepayCons::getProductionBaseUrl($this->isCloudServer);
        } else {
            // return "https://dev.nicepay.co.id/nicepay/";
            return  NicepayCons::getSandboxBaseUrl($this->isCloudServer);
        }
    }
...
class NICEPayBuilder
{
    ...
    public function setIsCloudServer($isCloudServer): NICEPayBuilder
    {
