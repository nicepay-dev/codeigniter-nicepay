...
class NicepayResponse
{
    ...
    private function __construct(NicepayResponseBuilder $builder)
    {
        ...
        $this->cancelMessage = $builder->getCancelMessage();
        $this->cancelVATime = $builder->getCancelVATime();
        ...
        $this->appRedirectUrl = $builder->getAppRedirectUrl();
    ...
    public static function fromArray(array $data): self
    {
        $builder = (new NicepayResponseBuilder())
            ...
            ->setCancelMessage($data['cancelMessage'] ?? null)
            ->setCancelVATime($data['cancelVATime'] ?? null)
            ...
            ->setAppRedirectUrl($data['appRedirectUrl'] ?? null)
    ...
    // public function getAppRedirectUrl()
    // {
    ...
    public function getCancelVATime()
    {
        return $this->cancelVATime;
    }
...
class NicepayResponseBuilder
{
    ...
    public function setCancelMessage($cancelMessage): NicepayResponseBuilder
    {
        $this->cancelMessage = $cancelMessage;
        return $this;
    }

    public function setCancelVATime($cancelVATime): NicepayResponseBuilder
    {
        $this->cancelVATime = $cancelVATime;
        return $this;
    }
    ...
    public function setAppRedirectUrl($appRedirectUrl): NicepayResponseBuilder
    {
